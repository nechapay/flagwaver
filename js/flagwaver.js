...
;( function ( window, document, THREE, undefined ) {
    ...
    var vertexShader, fragmentShader,
        ...
        flag, publicFlag, flag2, publicFlag2, flag3, publicFlag3;
    ...
    function init () {
        ...
        var pl2 = new THREE.Mesh( poleGeo, poleMat );
        pl2.position.y    = -300;
        pl2.position.x    = -304;
        ...
        flag2 = new Flag();
        flag2.setTopEdge( 'left' );
        flag2.setHoisting( 'dexter' );
        flag2.setPosition( 300, 100, 0 );
        flag2.setTexture( blankTexture );
        scene.add( flag2.object );
        publicFlag2 = flag2.createPublic();

        flag3 = new Flag();
        flag3.setTopEdge( 'left' );
        flag3.setHoisting( 'dexter' );
        flag3.setPosition( -300, 200, 0 );
        flag3.setTexture( blankTexture );
        scene.add( flag3.object );
        publicFlag3 = flag3.createPublic();
    ...
    function animateFrame () {
        ...
        windForce.set( 10000, 10000, 10000 ).normalize().multiplyScalar( windStrength );
